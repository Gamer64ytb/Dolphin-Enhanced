...
private:
  void StoreFromRegister(int sbits, ARM64Reg reg)
  {
    ...
    {
    case 8:
      m_emit->STRB(INDEX_UNSIGNED, reg, ARM64Reg::X0, 0);
      break;
    case 16:
      m_emit->STRH(INDEX_UNSIGNED, reg, ARM64Reg::X0, 0);
      break;
    case 32:
      m_emit->STR(INDEX_UNSIGNED, reg, ARM64Reg::X0, 0);
      break;
    default:
  ...
  void LoadToRegister(int sbits, bool dont_extend)
  {
    ...
    case 8:
      if (m_sign_extend && !dont_extend)
        m_emit->LDRSB(INDEX_UNSIGNED, m_dst_reg, ARM64Reg::X0, 0);
      else
        m_emit->LDRB(INDEX_UNSIGNED, m_dst_reg, ARM64Reg::X0, 0);
      break;
    case 16:
      if (m_sign_extend && !dont_extend)
        m_emit->LDRSH(INDEX_UNSIGNED, m_dst_reg, ARM64Reg::X0, 0);
      else
        m_emit->LDRH(INDEX_UNSIGNED, m_dst_reg, ARM64Reg::X0, 0);
      break;
    case 32:
      m_emit->LDR(INDEX_UNSIGNED, m_dst_reg, ARM64Reg::X0, 0);
      break;
    default:
