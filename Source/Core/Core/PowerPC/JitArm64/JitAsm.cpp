...
void JitArm64::GenerateAsm()
{
  ...
  STR(INDEX_UNSIGNED, ARM64Reg::X0, ARM64Reg::X1, 0);
  MOVP2R(ARM64Reg::X1, &m_stack_pointer);
  LDR(INDEX_UNSIGNED, ARM64Reg::X0, ARM64Reg::X1, 0);
  ...
  STP(INDEX_PRE, ARM64Reg::ZR, ARM64Reg::X0, ARM64Reg::SP, -16);

  // Store the stack pointer, so we can reset it if the BLR optimization fails.
  ADD(ARM64Reg::X0, ARM64Reg::SP, 0);
  STR(INDEX_UNSIGNED, ARM64Reg::X0, PPC_REG, PPCSTATE_OFF(stored_stack_pointer));
  ...
  LDR(INDEX_UNSIGNED, ARM64Reg::W0, ARM64Reg::X0, 0);
...
void JitArm64::GenerateCommonAsm()
{
  ...
  {
    ADD(addr_reg, addr_reg, MEM_REG);
    float_emit.LDR(16, INDEX_UNSIGNED, ARM64Reg::D0, addr_reg, 0);
    ...
    float_emit.LDR(32, INDEX_UNSIGNED, ARM64Reg::D1, scale_reg, 0);
  ...
  {
    ADD(addr_reg, addr_reg, MEM_REG);
    float_emit.LDR(32, INDEX_UNSIGNED, ARM64Reg::D0, addr_reg, 0);
    float_emit.REV32(8, ARM64Reg::D0, ARM64Reg::D0);
    RET(ARM64Reg::X30);
  }
  ...
  {
    ADD(addr_reg, addr_reg, MEM_REG);
    float_emit.LDR(8, INDEX_UNSIGNED, ARM64Reg::D0, addr_reg, 0);
    float_emit.UXTL(8, ARM64Reg::D0, ARM64Reg::D0);
    float_emit.UXTL(16, ARM64Reg::D0, ARM64Reg::D0);
    float_emit.UCVTF(32, ARM64Reg::D0, ARM64Reg::D0);
  ...
  const u8* storePairedU8Slow;
  {
    auto emit_quantize = [this, &float_emit, scale_reg]() {
      ...
      ADD(scale_reg, ARM64Reg::X2, scale_reg, ArithOption(scale_reg, ST_LSL, 3));
      float_emit.LDR(32, INDEX_UNSIGNED, ARM64Reg::D1, scale_reg, 0);
      float_emit.FMUL(32, ARM64Reg::D0, ARM64Reg::D0, ARM64Reg::D1, 0);
  ...
  const u8* storeSingleFloatSlow;
  {
    ...
    float_emit.REV32(8, ARM64Reg::D0, ARM64Reg::D0);
    ADD(addr_reg, addr_reg, MEM_REG);
    float_emit.STR(32, INDEX_UNSIGNED, ARM64Reg::D0, addr_reg, 0);
    RET(ARM64Reg::X30);
