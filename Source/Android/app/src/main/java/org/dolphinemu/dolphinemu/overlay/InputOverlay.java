...
public final class InputOverlay extends SurfaceView implements OnTouchListener
{
                                                                 ...
                                                                 int pressedResInner, int joystick)
  {
    ...
    int resOuter = R.drawable.gcwii_joystick_range;
    Bitmap bitmapOuter = getInputBitmap(resOuter, scale);
    Bitmap bitmapInnerDefault = getInputBitmap(defaultResInner, 1.0f);
    Bitmap bitmapInnerPressed = getInputBitmap(pressedResInner, 1.0f);
  ...
  private Bitmap getInputBitmap(int id, float scale)
  {
  ...
  public static final int[] ResGameCubeIds =
  {
          // gamecube
  ...
  public static final String[] ResGameCubeNames = {
  ...
  public static final int[] ResWiimoteIds =
  {
          // wiimote
  ...
  public static final String[] ResWiimoteNames = {
  ...
  public static final int[] ResClassicIds =
  {
  ...
  public static final String[] ResClassicNames = {
